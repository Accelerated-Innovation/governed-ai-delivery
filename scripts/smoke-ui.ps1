<#
.SYNOPSIS
  Smoke-tests govkit across the agent x UI-shape x level matrix.
...
.DESCRIPTION
  ...
  L3: validate short-circuits (no per-feature artifacts). The apply itself
      is what proves the UI shape is wired up correctly at this level.
...
.EXAMPLE
  .\smoke-ui.ps1
  .\smoke-ui.ps1 -Agents claude-code -Types ui-react -Levels 4 -Force
