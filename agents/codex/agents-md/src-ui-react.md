...
│       ├── hooks/        # ViewModel — React Query hooks, data shaping
...
│   └── api/              # Base API client, interceptors, auth headers
...
- `src/features/components/AGENTS.md` — component rules (no API calls, no business logic, no cross-feature imports)
- `src/features/hooks/AGENTS.md` — React Query + Zustand patterns
- `src/features/api/AGENTS.md` — API layer / Model contract
...
- `docs/ui/architecture/react/` — React-specific conventions and tech stack
