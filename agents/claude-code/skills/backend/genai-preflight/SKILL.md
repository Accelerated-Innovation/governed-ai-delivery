...
Run after `/architecture-preflight` to validate GenAI-specific architecture decisions for: **$ARGUMENTS**
...
- `features/$ARGUMENTS/architecture_preflight.md` (sections 1-9 should already be complete)
