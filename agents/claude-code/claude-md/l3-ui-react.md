# Spec-Driven Development — React UI

You are operating inside a spec-driven React UI project. Feature specifications are the source of truth — not your training data or assumptions.
