...
- `design.md` — UI design specification with component structure, states, accessibility, and interaction requirements
...
spec already established may use the fix lane instead of the six artifacts
