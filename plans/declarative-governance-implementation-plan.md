...
- Current increment: I11a [PR #195](https://github.com/Accelerated-Innovation/governed-ai-delivery/pull/195) on `feat/148-posture-export`, implementation `9868de3` committed/pushed; the verified missing-owner Qodo finding is fixed and validated, pending delivery. Adds privacy-filtered, deterministic maintenance posture reports using canonical replay, a strict export schema, matching human output and explicit create-only artifact publication. Preserve independent dimensions and unknown evidence; do not derive another assessment engine or transmit automatically.
