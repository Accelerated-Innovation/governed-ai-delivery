...
Status: I00–I12 merged; I10 external-caller acceptance remains open; I13a onboarding and release-readiness documentation validated locally, delivery pending.
Plan version: 1.40.
Prepared: 2026-09-23.
...
| I13 | in progress | I13a capability onboarding, executable recipe and actual skill inventory; twenty new regression/control cases | I13b requires maintainer release/warning decision, real pilot observations and protected-caller evidence; no retirement scheduled |
...
- I13a is on `feat/149-release-readiness`: README leads with explicit profiles/packs and references an executable onboarding guide; existing marker users retain migration/rollback and the legacy bundle path. No consumer bundle is installed into GovKit source.
...
- Next action: commit/push the verified I13a changes and open its PR, then record delivery in the plan/issues. Do not merge without separate authorization. I13b and full release-candidate completion retain actual pilot/provider evidence and the explicit retirement decision.
