...
Status: I00–I11b merged; I10 external-caller acceptance remains open; I11c offline aggregation, scenarios and pilot protocol are locally verified, pending delivery/integration.
Plan version: 1.37.
Prepared: 2026-09-23.
...
- Current increment: I11c on `feat/148-posture-aggregation`; [ADR 0016](decisions/0016-offline-posture-aggregation.md) defines an explicit cohort, clock and selected per-kind snapshots. Deliver offline replayable counts, overlapping maintenance categories/freshness, complete synthetic scenarios and the separate voluntary team pilot protocol. No automatic collection or identity join between maintenance and change evidence.
...
- Next action: commit/push I11c and open its PR under the standing instruction; after integration reconcile I12 prerequisites and outstanding I10 external-caller evidence. Do not merge without separate authorization.
