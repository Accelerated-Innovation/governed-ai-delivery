...
- **Delivery/status:** remediation targets existing [PR #190](https://github.com/Accelerated-Innovation/governed-ai-delivery/pull/190). The current Qodo catalog exposes only structured findings reads; prefer automatic re-attribution after push, and do not claim closed findings without a confirming response. #145/#146/#149/#142 remain open with unchanged acceptance scope. Re-review and fix-head CI are pending; I09b remains next after integration.
