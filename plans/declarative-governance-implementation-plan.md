...
Status: I00–I11 merged; I10 external-caller acceptance remains open; I12 limited source self-hosting verified locally, pending PR integration.
Plan version: 1.38.
Prepared: 2026-09-23.
...
| I12 | in progress | Minimal source profile/empty lock, real source checks and canonical posture; twenty new tests, 4,676 fast passes, 51 final focused passes, actual source and installed-wheel proof | Local demonstration complete; commit/PR integration pending. I10 external enforcement remains unknown |
...
- Current increment: I12 on `feat/149-source-self-hosting`, based on `3ab9f39`. [ADR 0017](decisions/0017-limited-source-self-hosting.md) and [source guide](SOURCE_SELF_HOSTING.md) define minimal source metadata, always-required local controls, explicit execution, separate reviewed policy and canonical unknowns. No consumer pack, native skill or legacy marker is installed.
...
- Next action: commit/push and create the verified I12 PR under the standing instruction. After integration, reconcile I13 release hardening and remaining external inputs; do not silently choose a retirement release or claim pilot/provider evidence. Do not merge without separate authorization.
