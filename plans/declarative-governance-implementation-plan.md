...
Status: I00–I11a merged; I10 external-caller acceptance remains open; I11b change posture implemented and validated, pending PR delivery/integration.
Plan version: 1.35.
Prepared: 2026-09-23.
...
- Current increment: I11b on `feat/148-change-posture` implemented and validated, pending PR delivery: pure canonical change-result projection and schema, workflow/capability/control/evaluation descriptors, human/JSON parity and explicit private publication. Maintenance snapshots keep their existing contract. I11c retains cross-snapshot aggregation/denominators, complete maintenance scenarios and the voluntary adoption pilot; no acceptance is waived.
...
- Next action: commit/push I11b, open its PR and update issue delivery status. Review/integration precedes I11c; no merge without separate authorization.
