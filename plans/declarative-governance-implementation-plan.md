...
Status: I00–I11a merged; I10 external-caller acceptance remains open; I11b change posture delivered in PR #196, pending review/integration.
Plan version: 1.35.
Prepared: 2026-09-23.
...
- Current increment: I11b [PR #196](https://github.com/Accelerated-Innovation/governed-ai-delivery/pull/196) on `feat/148-change-posture`, implementation `c16c751` committed/pushed: pure canonical change-result projection and schema, workflow/capability/control/evaluation descriptors, human/JSON parity and explicit private publication. Maintenance snapshots keep their existing contract. I11c retains cross-snapshot aggregation/denominators, complete maintenance scenarios and the voluntary adoption pilot; no acceptance is waived.
...
- Validation: **65 focused reporting passes (32 new cases); 4,579 fast-suite passes, 2 existing skips, 150 e2e deselected (318.68s)**. The fresh runtime-only Python 3.12 wheel passed seven real change pilots plus six maintenance pilots; bundled examples replay. Scoped Ruff/format/whitespace checks and schema validity pass. Fifteen non-plan paths match the tested fingerprint.
