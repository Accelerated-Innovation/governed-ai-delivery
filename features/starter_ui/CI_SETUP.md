...
- **ui-quality-gate.yml** — Type checking, linting, component tests, bundle size
- **ui-eval-gate.yml** (L4+ only) — Accessibility and E2E evaluation predictions
- **quality-gate.yml** (if backend also lives here) — Architecture boundaries, security scans
...
- [ ] Configure other CI workflows (ui-quality-gate, ui-eval-gate, etc.)
